...
const TITLE_KEY: Record<PeekFail['reason'], string> = {
...
const DESC_KEY: Record<PeekFail['reason'], string> = {
  not_found: 'inviteNotFoundDesc',
  used: 'inviteUsedDesc',
  expired: 'inviteExpiredDesc',
  server_error: 'errorDesc',
};
    ...
    return (
      <Card className="w-full max-w-md border-border bg-card">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-xl text-foreground">{t(TITLE_KEY[peek.reason])}</CardTitle>
          <CardDescription className="text-muted-foreground">
            {t(DESC_KEY[peek.reason])}
          </CardDescription>
        </CardHeader>
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              {t("acceptInfo", { account: peek.account_name })}
            </p>
          </CardContent>
        </Card>
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-popover-foreground">
                ...
                {t("cantJoin")} {peek.account_name} {t("withThisAccount")}
              </DialogTitle>
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                {t("cantJoinDesc", { account: peek.account_name })}
              </p>
            </div>
